...
class DivisiController extends Controller
{
    ...
    public function create(): View
    {
        ...
        return view('admin.divisi.create', compact('employes'));
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect('admin/divisi')->with('success', 'Data divisi berhasil disimpan');
    }
    ...
    public function edit(Divisi $divisi): View
    {
        ...
        return view('admin.divisi.edit', compact('divisi', 'employes'));
    }
    ...
    public function update(Request $request, Divisi $divisi): RedirectResponse
    {
        ...
        return redirect('admin/divisi')->with('success', 'Data divisi berhasil diperbarui');
    }
    ...
    public function destroy(Divisi $divisi): RedirectResponse
    {
        ...
        return redirect('admin/divisi')->with('success', 'Data divisi berhasil dihapus');
    }
}
